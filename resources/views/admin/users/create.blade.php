                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="role_as" class="form-control @error('role_as') is-invalid  @enderror">
                                ...
                                <option value="admin" {{(!$errors->has('role_as') && old('role_as') == 'admin' ) ? 'selected' : '' }}>Admin</option>
                                <option value="user"  {{(!$errors->has('role_as') && old('role_as') == 'user' ) ? 'selected' : '' }}>User</option>
                            </select>
                            @error('role_as')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
