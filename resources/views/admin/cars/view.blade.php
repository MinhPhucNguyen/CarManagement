        ...
        <div class="view-container w-100 bg-dark-subtle d-flex rounded">
            <div class="view-left w-50 d-flex">
                <div class="image w-25">
                    <img src="{{ asset('/upload/cars/' . $car->image) }}" alt="avatar" class="rounded"
                    ...
                    <div class="row">
                        <div class="info-title">
                            <ul>
                                ...
                                <li class="text-end fw-bolder mb-4">CarLicensePlate</li>
                                <li class="text-end fw-bolder mb-4">Color</li>
                                <li class="text-end fw-bolder mb-4">Price</li>
                            </ul>
                        </div>
                        <div class="info w-75">
                            <ul>
                                <li class="mb-4">{{ $car->carName }}</li>
                                <li class="mb-4">{{ $car->CarLicensePlate }}</li>
                                <li class="mb-4">{{ $car->color }}</li>
